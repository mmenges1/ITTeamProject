<html>
	...
	//			numOpponents = 1; //queries[1]
			...
			function displayEndGame(points)
			{
				...
				document.getElementById('active').innerHTML =	"You won "+points[0].human+" rounds";
				if(numOpponents >= 1){
					document.getElementById('playerInformation').innerHTML = "AI 1 won "+points[0].ai1+" rounds";
				}
				if(numOpponents >= 2){
					document.getElementById('playerInformation').innerHTML += "AI 2 won "+points[0].ai2+" rounds</br>";
				}
				if(numOpponents >= 3){
					document.getElementById('playerInformation').innerHTML += "AI 3 won "+points[0].ai3+" rounds</br>";
				}
				if(numOpponents >= 4){
					document.getElementById('playerInformation').innerHTML += "AI 4 won "+points[0].ai4+" rounds</br>";
				}
