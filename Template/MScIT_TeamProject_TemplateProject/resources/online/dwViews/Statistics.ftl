								...
								<div class="col-md-8 col-sm-12">
									<div class="media">
										<div class="media-body">
											...
											Number of overall games played here</div>
										</div>
									</div>
								</div>
								<hr>
									...
									<div class="col-md-8 col-sm-12">
										<div class="media">
											<div class="media-body">
												...
												Computer has won this many times</div>
											</div>
										</div>
									</div>
									<hr>
										...
										<div class="col-md-8 col-sm-12">
											<div class="media">
												<div class="media-body">
													...
													Player has won this many times</div>
												</div>
											</div>
										</div>
										<hr>
											...
											<div class="col-md-8 col-sm-12">
												<div class="media">
													<div class="media-body">
														...
														Average number of draws placed here</div>
													</div>
												</div>
											</div>
											<hr>
